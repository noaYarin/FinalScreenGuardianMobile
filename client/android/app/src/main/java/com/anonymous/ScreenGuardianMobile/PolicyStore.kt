 ...
 * PolicyStore
 *
 * Local persistence layer for device policy and usage data.
 * Uses SharedPreferences to store enforcement-related data.
 */
object PolicyStore {
    ...
    // Aliases used by socket code.
    // These intentionally use the same key as heartbeat device id.
    fun setDeviceId(context: Context, value: String) {
        setHeartbeatDeviceId(context, value)
    }

    fun getDeviceId(context: Context): String? {
        return getHeartbeatDeviceId(context)
    }
